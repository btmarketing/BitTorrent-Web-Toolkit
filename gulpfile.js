...
var config = {
	...
	src: {
		...
		styles: {
			...
			toolkit: 'src/assets/toolkit/styles/style.scss'
		},
...
gulp.task('copyjs', function() {
    gulp.src('src/assets/toolkit/scripts/*')
    .pipe(gulp.dest('dist/assets/toolkit/scripts'));
});

// concat javascript
gulp.task('concatjs', function() {
  return gulp.src('src/assets/toolkit/scripts/partials/*.js')
    .pipe(concat('all.js'))
    .pipe(gulp.dest('./dist/assets/toolkit/scripts'));
});
...
gulp.task('copyimages', function() {
    gulp.src('src/assets/toolkit/images/*')
